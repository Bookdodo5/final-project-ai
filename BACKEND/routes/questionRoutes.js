...
router.get("/module/:moduleId", asyncWrapper(questionController.getQuestionsByModuleId));
router.get("/:questionId", asyncWrapper(questionController.getQuestionById));
router.delete("/:questionId", asyncWrapper(questionController.deleteQuestionById));
